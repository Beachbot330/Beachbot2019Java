 ...
 *
 */
public class LoadBall extends BBCommandGroup {
    ...
    //this command is designed to be a sensored ball pickup from the human player station
    ...
    addParallel(new SetLiftPosition(LiftConst.DeployBallLow));
