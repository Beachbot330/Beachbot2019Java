...
public class SensorCloseClawHatch extends BBCommand {
    ...
    protected void initialize() {
        consecutiveHasHatches = 0;
    }

    // Called repeatedly when this Command is scheduled to run
    @Override
    protected void execute() {
        if (Robot.pickup.getHasHatch()){
    		this.consecutiveHasHatches ++;
    	}
    	else {
    		this.consecutiveHasHatches = 0;
    	}
    }
    ...
    protected boolean isFinished() {
        return consecutiveHasHatches > GrabberConst.hasHatchMinRepitition;
    }
