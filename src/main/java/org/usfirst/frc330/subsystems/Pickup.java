...
public class Pickup extends Subsystem {
    ...
    private SharpIR leftSensor;
    private SharpIR middleSensor;
    private SharpIR rightSensor;
    ...
    public Pickup() {
        ...
        leftSensor = new SharpIR(SharpType.GP2Y0A41SK0F, 1);
        addChild(leftSensor);
        
        
        middleSensor = new SharpIR(SharpType.GP2Y0A41SK0F, 2);
        addChild(middleSensor);
        
        
        rightSensor = new SharpIR(SharpType.GP2Y0A41SK0F, 3);
