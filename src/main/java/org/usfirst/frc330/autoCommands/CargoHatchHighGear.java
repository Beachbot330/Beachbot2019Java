...
public class CargoHatchHighGear extends BBCommandGroup {
    ...
    Waypoint wp1 = new Waypoint(20, 236, 0); // Near cargo ship
    Waypoint wp2 = new Waypoint(62, 96+30, 0); //Near rocket
    Waypoint wp3 = new Waypoint(67, 00+10, 0); //Near human player
    Waypoint wp4 = new Waypoint(22, 255, 0); //Cargo Ship Far
    ...
    public CargoHatchHighGear(boolean leftSide, boolean redTeam) {
       ...
       // addSequential(new ShiftLow());
        ...
        addSequential(new DriveLimelightCurrentSense(0.3, 1.0, 10));
        ...
        //backup
        addSequential(new ShiftHigh());
        addSequential(new DriveWaypointBackward(wp4, invert, 3.0, 3.0, true, ChassisConst.DriveHighSlow, ChassisConst.GyroDriveHigh));
