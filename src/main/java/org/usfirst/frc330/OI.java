...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("LoopIfWeHaveObject", new LoopIfWeHaveObject());
        SmartDashboard.putData("LoopIfWeHaveHatch", new LoopIfWeHaveHatch());
        SmartDashboard.putData("SensorCloseClawBall", new SensorCloseClawBall());
        SmartDashboard.putData("SensorCloseClawHatch", new SensorCloseClawHatch());
        SmartDashboard.putData("RollerUntilBall", new RollerUntilBall());
