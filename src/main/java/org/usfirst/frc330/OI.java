...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("BarYellow", new BarYellow());
        SmartDashboard.putData("BarGreen", new BarGreen());
        SmartDashboard.putData("BarRed", new BarRed());
        SmartDashboard.putData("BarBlue", new BarBlue());
        SmartDashboard.putData("BarPurple", new BarPurple());
        SmartDashboard.putData("BarWhite", new BarWhite());
