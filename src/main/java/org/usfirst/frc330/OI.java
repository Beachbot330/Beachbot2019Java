...
public class OI {
    ...
    public POVButton liftUpSensored;
    public POVButton liftDownSensored;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        //D-Pad Buttons
        liftUpSensored = new POVButton(gamePad, 0, 0);  //Up
        liftDownSensored = new POVButton(gamePad, 0, 180); //Down
